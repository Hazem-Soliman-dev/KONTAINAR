...
const CampaignCalendar = () => {
  ...
  const [sections, setSections] = useState([
    {
      ...
      content: 'Manage campaign calendar and scheduling.',
      isExpanded: true,
    },
    {
      id: 2,
      title: 'Campaign Rules',
      content: 'Configure campaign rules and policies.',
      isExpanded: false,
    },
    {
      id: 3,
      title: 'Campaign Tracking',
      content: 'Track campaign performance and metrics.',
      isExpanded: false,
    },
    {
      id: 4,
      title: 'Campaign Analytics',
      content: 'View campaign analytics and reports.',
      isExpanded: false,
    },
  ]);
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: 'Campaign calendar updated successfully',
        severity: 'success',
      });
    }, 1000);
  };
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: 'Campaign calendar refreshed successfully',
        severity: 'success',
      });
    }, 1000);
  };
        ...
        >
          <Box>
            ...
            <Typography variant="body1" sx={{ mb: 2, color: 'text.secondary' }}>
              Schedule and manage marketing campaigns with calendar view
            </Typography>
            <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} sx={{ mt: 1 }}>
              ...
              <Link color="inherit" href="/main-store/pricing/campaigns">
                Campaigns
              </Link>
              <Typography color="text.primary">Campaign Calendar</Typography>
            </Breadcrumbs>
          </Box>
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid size={{ xs: 12, md: 2 }}>
            <FormControl fullWidth size="small">
              ...
              <Select value="all" label="Campaign Status">
        ...
        <Grid size={{ xs: 12, md: 8 }}>
          <Card>
            <CardContent>
              ...
              >
                <Typography variant="h6">Campaign Calendar Processes</Typography>
              ...
              {sections.length === 0 && (
                <Box sx={{ textAlign: 'center', py: 4 }}>
                  ...
                  <Typography variant="h6" color="text.secondary">
                    No campaign calendar processes yet
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add your first campaign calendar process to get started
                  </Typography>
                  <Button variant="contained" startIcon={<AddIcon />} onClick={handleAddSection}>
                    Add First Process
                  </Button>
