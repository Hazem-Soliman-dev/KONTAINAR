...
const Customers = () => {
  ...
  return (
    <PageContainer title="إدارة العملاء" description="إدارة شاملة لعملاء متجرك">
      <Breadcrumb title="إدارة العملاء" items={BCrumb} />
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            ...
            >
              <CardContent sx={{ p: 0 }}>
                <Avatar
                  sx={{ bgcolor: 'secondary.main', width: 48, height: 48, mx: 'auto', mb: 2 }}
                >
                  <ShoppingCartIcon />
                </Avatar>
