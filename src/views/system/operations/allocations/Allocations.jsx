...
const Allocations = () => {
  ...
  const [sections, setSections] = useState([
    {
      id: 1,
      title: 'عملية التخصيص',
      content: 'إدارة تخصيصات وتعيينات المخزون.',
      isExpanded: true,
    },
    {
      id: 2,
      title: 'قواعد التخصيص',
      content: 'تكوين قواعد وسياسات التخصيص.',
      isExpanded: false,
    },
    {
      id: 3,
      title: 'تتبع التخصيص',
      content: 'تتبع تقدم وحالة التخصيص.',
      isExpanded: false,
    },
    {
      id: 4,
      title: 'تحليلات التخصيص',
      content: 'عرض أداء وتحليلات التخصيص.',
      isExpanded: false,
    },
  ]);
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: 'Allocations refreshed successfully',
        severity: 'success',
      });
    }, 1000);
  };
        ...
        >
          <Box>
            ...
            <Typography variant="body1" sx={{ mb: 2, color: 'text.secondary' }}>
              Manage inventory allocations and assignments with automated workflows
            </Typography>
            <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} sx={{ mt: 1 }}>
              ...
              <Typography color="text.primary">Allocations</Typography>
            </Breadcrumbs>
          </Box>
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid size={{ xs: 12, md: 2 }}>
            <FormControl fullWidth size="small">
              ...
              <Select value="all" label="Allocation Status">
        ...
        <Grid size={{ xs: 12, md: 8 }}>
          <Card>
            <CardContent>
              ...
              >
                <Typography variant="h6">Allocation Processes</Typography>
              ...
              {sections.length === 0 && (
                <Box sx={{ textAlign: 'center', py: 4 }}>
                  ...
                  <Typography variant="h6" color="text.secondary">
                    No allocation processes yet
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add your first allocation process to get started
                  </Typography>
                  <Button variant="contained" startIcon={<AddIcon />} onClick={handleAddSection}>
                    Add First Process
                  </Button>
