...
const PaymentMethods = () => {
  ...
  const [sections, setSections] = useState([
    ...
    },
    {
      ...
      content: 'Payments are processed securely through our payment gateway.',
      isExpanded: false,
    },
    {
      id: 3,
    ...
    },
    {
      id: 4,
      title: 'Security',
      content: 'All payment information is encrypted and secure.',
      isExpanded: false,
    },
  ]);
  ...
  const paymentStats = [
    ...
    },
    {
      ...
      value: `${formData.processingTime} day`,
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: 'Payment methods policy updated successfully',
        severity: 'success',
      });
    }, 1000);
  };
        ...
        >
          <Box>
            <Typography variant="h4" gutterBottom sx={{ color: 'primary.main', fontWeight: 700 }}>
              Payment Methods Policy Management
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Manage your store's payment methods policy and conditions
            </Typography>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Configure and manage your payment methods policy
            </Typography>
          </Box>
        </Box>
            ...
            <CardContent>
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12 }}>
                  <TextField
                    fullWidth
                    label="Refund Time (Days)"
                    type="number"
                    value={formData.refundTime}
                    onChange={(e) => setFormData({ ...formData, refundTime: e.target.value })}
                    size="small"
                  />
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <TextField
                    ...
                    multiline
                    rows={3}
                    value={formData.acceptedMethods}
                    onChange={(e) => setFormData({ ...formData, acceptedMethods: e.target.value })}
                    size="small"
