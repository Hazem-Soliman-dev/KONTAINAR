...
const MerchandisingReports = () => {
  ...
  const [sections, setSections] = useState([
    {
      id: 1,
      title: 'عملية تقرير التسويق',
      content: 'إنشاء وإدارة تقارير التسويق.',
      isExpanded: true,
    },
    {
      id: 2,
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: 'Merchandising report settings updated successfully',
        severity: 'success',
      });
    }, 1000);
  };
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 3 }}>
        <Typography variant="h4" gutterBottom color="primary.main">
          Merchandising Reports Management
        </Typography>
        <Typography variant="body2" color="text.secondary">
          Generate and manage your store's merchandising reports
        </Typography>
        <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} sx={{ mt: 1 }}>
          ...
          <Typography color="text.primary">Merchandising Reports</Typography>
        </Breadcrumbs>
      </Box>
...
export default MerchandisingReports;
