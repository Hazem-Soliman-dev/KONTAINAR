...
const RefundPolicy = () => {
  ...
  const [sections, setSections] = useState([
    {
      id: 1,
      title: 'Refund Window',
      content: 'You have 30 days from the delivery date to request a refund.',
      isExpanded: true,
    },
    {
      id: 2,
  ...
  const policyStats = [
    ...
    {
      title: 'Refund Window',
      value: `${formData.refundWindow} days`,
    ...
    {
      title: 'Processing Time',
      value: `${formData.processingTime} days`,
        ...
        >
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Manage your store's refund policy and conditions
            </Typography>
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12 }}>
                  <TextField
                    ...
                    onChange={(e) => setFormData({ ...formData, refundWindow: e.target.value })}
                    size="small"
                  />
                </Grid>
                <Grid size={{ xs: 12 }}>
                ...
                <Grid size={{ xs: 12 }}>
                  <TextField
                    ...
                    multiline
                    rows={3}
                    value={formData.refundReasons}
                    onChange={(e) => setFormData({ ...formData, refundReasons: e.target.value })}
                    size="small"
                    placeholder="List acceptable refund reasons..."
                  />
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <TextField
