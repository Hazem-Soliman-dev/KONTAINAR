...
const SearchReports = () => {
  ...
  const [sections, setSections] = useState([
    {
      id: 1,
      title: 'عملية تقرير البحث',
      content: 'إنشاء وإدارة تقارير البحث.',
      isExpanded: true,
    },
    {
      id: 2,
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: 'Search report settings updated successfully',
        severity: 'success',
      });
    }, 1000);
  };
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Generate and manage your store's search reports
        </Typography>
        <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} sx={{ mt: 1 }}>
          ...
          <Typography color="text.primary">Search Reports</Typography>
        </Breadcrumbs>
      </Box>
